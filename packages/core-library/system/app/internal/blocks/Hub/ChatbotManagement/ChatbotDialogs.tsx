  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        >
          <Typography>Subsequent Form</Typography>
          <Typography>
      ...
      >
        ...
        >
          <div className="flex items-center justify-start gap-2">
            ...
            />
            <Typography
              sx={{ color: "#F1664B", fontSize: "1.5rem", fontWeight: "bold" }}
            >
              Confirm End of Conversation
            </Typography>
          </div>
          <Typography>
            Are you sure after this subsequent you want to end this
