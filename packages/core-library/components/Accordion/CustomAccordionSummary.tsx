...
const StyledAccordionSummary = styled(AccordionSummary, {
  shouldForwardProp: (prop) =>
    prop !== "expanded" && prop !== "accordionRadius",
})<{
  expanded: boolean;
  headerBackgroundColor: string;
  headerHeight: string;
  ...
  borderTopLeftRadius: expanded
    ? accordionRadius || "0"
    : accordionRadius || "0",
  borderTopRightRadius: expanded
    ? accordionRadius || "0"
    : accordionRadius || "0",
  borderRadius: expanded
    ? `${accordionRadius || "0"} ${accordionRadius || "0"} 0 0`
    : accordionRadius || "0",
  border: "none",
}));

export const CustomAccordionSummary: React.FC<
  React.PropsWithChildren<CustomAccordionSummaryProps>
> = ({
  expanded,
  children,
