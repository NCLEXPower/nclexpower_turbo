        ...
        <div className='h-full w-full relative'>
          <div className='absolute w-full h-full flex'>
            <div className=' items-start justify-start lg:h-full w-1/2 flex flex-col left-0 text-white pl-10 lg:pl-20 pt-[25dvh]'>
              <p className='text-4xl sm:text-5xl md:text-7xl font-bold font-Rajdhani whitespace-nowrap'>
                Train like a
              </p>
              <p className='text-5xl sm:text-6xl md:text-8xl font-bold font-Poppins text-[#f4c501] -mt-4 lg:-mt-7'>
                BOXER
              </p>
            </div>
            <div className=' items-end justify-end lg:h-full w-1/2 flex flex-col right-0 text-white pr-10 lg:pr-28 pb-[12dvh] '>
              ...
              <p className='text-5xl sm:text-6xl md:text-8xl font-bold font-Poppins text-[#f4c501] -mt-4 lg:-mt-5'>
                WINNER
              </p>
            </div>
          </div>
