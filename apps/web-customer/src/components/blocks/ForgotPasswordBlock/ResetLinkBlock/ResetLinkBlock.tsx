...
export const ResetLinkBlock: React.FC<Props> = () => {
  ...
  //     </div>
  //     <div className="flex flex-col text-center gap-7 justify-center min-h-screen bg-[#f3f4f8] px-0 md:px-10 w-full lg:max-w-[600px]">
  ...
  //   </div>
  // );
  return <p>Reset link block is temporarily disabled.</p>;
};
